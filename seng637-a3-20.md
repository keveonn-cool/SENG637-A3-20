...
![Alt text](Images/range_statement.png)

Note: Please be aware that the displayed screen capture indicates a test coverage of 84% for the Range class. However, it should be noted that the remaining coverage was unattainable because of inaccessible code within the range class methods. Despite attempts to address this issue, additional tests were created following an analysis of the coverage through the EclEmma tool.

## Branch

![Alt text](Images/range_branch.png)

## Method

![Alt text](Images/range_method.png)
