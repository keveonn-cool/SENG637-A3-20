...
As you can see above, the red code is unreachable and therefore we increase the statement coverage
...
![Alt text](Images/Statement_Range.png)

## Branch

![Alt text](Images/Branch_Range.png)

## Method

![Alt text](Images/Method_Range.png)

# 2. DataUtilities 
## Statement
![Alt text](Images/DataUtilities.Statement.jpg)

## Branch
![Alt text](Images/.jpg)

## Method
![Alt text](Images/DataUtilities.Method.jpg)
