...
public class DataUtilitiesTest {
    ...
    // Test for createNumberArray2D method with null input
    @Test(expected = InvalidParameterException.class)
    ...
    // Test for getCumulativePercentages method with all zeros
    @Test
    public void testGetCumulativePercentages_AllZeros() {
        ...
        for (int i = 0; i < 3; i++) {
            assertEquals(0.0, result.getValue(i).doubleValue(), .000000001d);
        }
    }

    // Test for getCumulativePercentages method with null input
    @Test(expected = InvalidParameterException.class)
    ...
    // Test for cloning a null 2D array
    @Test
    ...
    // Test for calculating total with negative column index
    @Test(expected = IndexOutOfBoundsException.class)
    public void testCalculateColumnTotalNegativeColumnIndex() {
        DefaultKeyedValues2D values = new DefaultKeyedValues2D();
        int[] validRows = {0, 1, 2};

        DataUtilities.calculateColumnTotal(values, -1, validRows);
    }
    ...
    // Test for calculating total with negative row index
    @Test(expected = IndexOutOfBoundsException.class)
    public void testCalculateRowTotalNegativeRowIndex() {
        DefaultKeyedValues2D values = new DefaultKeyedValues2D();
        int[] validCols = {0, 1, 2};

        DataUtilities.calculateRowTotal(values, -1, validCols);
    }
